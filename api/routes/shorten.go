...
import (
	...
	"github.com/jintoples/url-shortener/api/database"
	"github.com/jintoples/url-shortener/api/helpers"
)
...
func ShortenURL(c *fiber.Ctx) error {
	...
	if val != "" {
		return c.Status(fiber.StatusForbidden).JSON(fiber.Map{"error": "URL custom short is already use"})
	}
